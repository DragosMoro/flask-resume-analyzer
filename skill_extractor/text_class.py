...
#
# my packs
from skill_extractor.cleaner import Cleaner, stem_text, find_index_phrase
from skill_extractor.general_params import S_GRAM_REDUNDANT
...
class Word:
    ...
    def __init__(
        ...
        Examples
        --------
        >>> from skill_extractor.text_class import Word
        >>> word_obj = Word("Hello")
        """
